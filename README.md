...
<img src="img/logo.png" alt="MIZO-AI Logo" width="200"/>
...
MIZO-AI is a serverless AI voice assistant developed entirely on the ESP32 platform using the Arduino environment. It allows you to run AI voice interactions directly on ESP32 devices without the need for additional server support. The system provides complete voice interaction capabilities including speech recognition, AI processing, and text-to-speech output.
...
2. **Library Installation via ZIP**
   ...
   **Method 1: Direct ZIP Installation (Recommended)**
   - Download or create a ZIP file of the entire `MIZO-AI` folder
   - Ensure the ZIP file structure has `library.properties` at the root level
   - Open Arduino IDE
   - Go to `Sketch` → `Include Library` → `Add .ZIP Library...`
   - Select the `MIZO-AI.zip` file
   - Wait for installation to complete

   **Method 2: Manual Installation**
   - Copy the entire `MIZO-AI` folder to your Arduino libraries directory:
